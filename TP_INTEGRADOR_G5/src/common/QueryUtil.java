...
public final class QueryUtil {
	...
	public static String buildQuery(String property, String className, String value) {
		return property.indexOf(".") == -1 ? FROM + className + where(property, value) 
	...
	public static String buildQueryByProperty(String property, String className, String value) {
		return FROM + className + where(property, value);
	}
	
	//Para acceder a propiedades de otro objeto
	public static String buildQueryByInnerProperty1(String property, String className, String value) {
		return buildInnerProperty(property, className, value) + where(property, value);
	}
	
	public static String buildQueryByInnerProperty2(String property, String className, String value) {
		return buildInnerProperty(property, className, value);
	}
	...
	private static String where(String property, String value) {
